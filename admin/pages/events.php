            ...
            <div class="table-responsive">
                <table id="tabla_personas" class="table table-striped table-bordered table-condensed" style="width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo $dat['date_event']?></td>
                            <td><?php echo $dat['time_event']?></td>
                            <td><?php echo $dat['event_description']?></td>
                            <td><?php echo $dat['event_status']?></td>
                            <td>   
                            </td>
                        </tr>
                        <?php
