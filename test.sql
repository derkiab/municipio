...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2022 a las 14:56:19
...
(1, '2022-12-15', '10:16:00', ' hgdfjsdnlfdf', 'https://sumedico.blob.core.windows.net/images/2020/07/13/gatosmichisignificado.jpg', 'actual', 'michi noticias 7'),
(7, '2022-12-18', '09:35:00', 'michis al poder 5  ', 'https://i.pinimg.com/736x/e0/c0/a4/e0c0a4aab16f04f250f4cc6b7946cf9d.jpg', 'finalizado', 'michi noticias 4 '),
(8, '2022-12-01', '11:45:00', 'Gato ', 'https://i.pinimg.com/736x/e0/c0/a4/e0c0a4aab16f04f250f4cc6b7946cf9d.jpg', 'Terminado', 'Gato');
...
(41, 3, 'reclamo saluud', '', 2, 2, 'Yo no robe nah'),
...
(2, 123456789, 'Derqui123', 'Sanhueza', 'derquis96@gmail.com', 1, 963434488, '12345', 'dir1'),
...
--
ALTER TABLE `opinions`
  MODIFY `id_opinion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
